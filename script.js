document.addEventListener('DOMContentLoaded', function () {
 ...
 sessionStorage.setItem('vaultAuthenticated', 'true');
        setTimeout(() => {
    ...
    if (loanAmountInput && interestRateInput && loanTenureInput) {
        ...
        function calculateEMI() {
            ...
            if (rate === 0) {
                ...
                totalAmount.textContent = formatCurrency(principal);
            } else {
                ...
                totalAmount.textContent = formatCurrency(Math.round(totalPayment));
            }
        }
